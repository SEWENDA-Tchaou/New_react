...
function Apropos() {
  return (
    <>
        <Navbar />
    <div className="bg-black py-5 lg:py-24 text-white ">
       <div>
        <h1 className=" w-32 text-blue-600 text-2xl m-8 lg:m-14 font-bold border-b-2 border-b-green-400">
            A propos
        </h1>
            ...
            <div className="lg:w-1/2 space-y-3">
                ...
                <div className="flex justify-between items-center">
                    <div className="lg:flex lg:justify-between lg:items-center">
                        <img src={html} className="w-full lg:w-[250px] h-24" alt="" />
                        <img src={css} className="w-full lg:w-[250px] h-24" alt="" />
                    </div>
                    <div className="lg:flex justify-between items-center">
                        <img src={php} className="w-[150px] lg:w-[250px] h-24" alt="" />
                        <img src={javascript} className="w-[150px] lg:w-[250px] h-24" alt="" />
                    </div>
                </div>
                <div className="lg:flex justify-between items-center">
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                        <img src={node} className="w-[150px]  lg:w-[250px] h-20 lg:h-24" alt="" />
                        <img src={wordpress} className="w-[150px] lg:w-[250px] h-20 lg:h-24" alt="" />
                    </div>
                </div>
                <div className="flex justify-between items-center">
                    <img src={figmalogo} className="w-full lg:w-[250px] h-20 lg:h-24" alt="" />
                    <img src={tailwindCss} className="w-[150px] lg:w-[250px] h-20 lg:h-24" alt="" />
                </div>
            </div>
        </div>
       </div>
