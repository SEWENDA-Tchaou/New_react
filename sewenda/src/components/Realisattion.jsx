...
import Gestion_stock from "../assets/img/Gestion_stock.png";
       ...
       <div>
        ...
        <div className="">
            <div className="flex justify-around items-center space-x-5">
              ...
              <a href="" className="border border-white/70 w-[300px] rounded-md">
              <img src={Gestion_stock} className="w-full h-[20vh] rounded-tl-md rounded-tr-md" alt="" />
                <p className="text-center py-2 bg-blue-600 rounded-bl-md rounded-br-md">Projet de creation de Aplli de gestion de stock</p>
              </a>
            </div>
        </div>
        {/* <div className="my-5">
